...
---
  ...
  # Not in combines the "rename_files_cyberball.R", which was run as a separete script for TDS2.
  # Output of this script isused with "id.events_cyb1.Rmd" and "id.events_cyb2.Rmd" for identify relevant events (and onsets/durations) for each individual.

...
scripts_folder<-'/projects/dsnlab/tds/TDS_scripts/behavioral/cyb'
unmerged_folder<-'TDS1_cyberball_data/unmerged/'
  
#read in cyberball files
files_folder<-paste(psi_folder,cyb_folder,sep='')
cb_data_long<-read.csv(paste(files_folder,"Merged_Log_1494973802.csv",sep=''))
...
for(i in 1:length(listFiles)) 
{
  ...
  if (df$userid[1] == "agileProgger") {
      ...
      setwd(paste(tds_folder,"behavior/CyberBall/multiconds/Labelled_Data",sep=""))

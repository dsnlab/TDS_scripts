...
anova(null.model, condition.model)  
#                 Df    AIC    BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)  
# null.model       2 6840.8 6854.0 -3418.4   6836.8                           
# condition.model  3 6839.5 6859.3 -3416.7   6833.5 3.3712      1    0.06635 .
summary(condition.model) 
# Fixed effects:
#             Estimate Std. Error z value Pr(>|z|)    
...
write.csv(PDS_mean_scores_TDS2, file = 'tds2_PDS_mean_score_n77.csv')
...
# run.model: go ~ run_index + (1 | scores.SID)
# interaction.model: go ~ Group * run_index + (1 | scores.SID)
#                   Df   AIC   BIC logLik deviance  Chisq Chi Df Pr(>Chisq)    
...
# Fixed effects:
#                  Estimate Std. Error z value Pr(>|z|)    
# (Intercept)      -0.49759    0.22800  -2.182 0.029077 *  
# Group            -0.05989    0.14386  -0.416 0.677186    
# run_index4       -0.16450    0.18287  -0.900 0.368366    
# run_index5       -0.19893    0.18210  -1.092 0.274652    
# run_index6        0.06604    0.18161   0.364 0.716148    
# run_index7       -0.44658    0.18466  -2.418 0.015591 *  
# run_index8       -0.49337    0.18357  -2.688 0.007197 ** 
# Group:run_index4  0.08048    0.11548   0.697 0.485869    
# Group:run_index5  0.19258    0.11480   1.677 0.093445 .  
# Group:run_index6  0.04393    0.11469   0.383 0.701670    
# Group:run_index7  0.38166    0.11566   3.300 0.000967 ***
# Group:run_index8  0.44914    0.11513   3.901 9.57e-05 ***

### hmm this was my output
# Random effects:
#  Groups     Name        Variance Std.Dev.
#  scores.SID (Intercept) 0.4871   0.698   
# Number of obs: 16580, groups:  scores.SID, 139
# 
# Fixed effects:
#                   Estimate Std. Error z value Pr(>|z|)    
# (Intercept)      -0.703994   0.195614  -3.599  0.00032 ***
# Group             0.131534   0.123246   1.067  0.28586    
# run_index1        0.207143   0.118022   1.755  0.07924 .  
# run_index2        0.041734   0.118676   0.352  0.72509    
# run_index3        0.007274   0.117751   0.062  0.95074    
# run_index4        0.271856   0.117130   2.321  0.02029 *  
# run_index5       -0.240859   0.120136  -2.005  0.04497 *  
# Group:run_index1 -0.191869   0.074497  -2.576  0.01001 *  
# Group:run_index2 -0.110835   0.074768  -1.482  0.13824    
# Group:run_index3  0.001304   0.073985   0.018  0.98594    
# Group:run_index4 -0.147107   0.073799  -1.993  0.04622 *  
# Group:run_index5  0.190668   0.074749   2.551  0.01075 * 

# condition effects on the proportion of Go decisions

null.model <- glmer(go ~ (1|scores.SID), data=allTDSfMRI, family='binomial')
condition.model <- glmer(go ~ condition + (1|scores.SID), data=allTDSfMRI, family='binomial')
interaction.model <- glmer(go ~ Group*condition + (1|scores.SID), data= allTDSfMRI, family='binomial')
anova(null.model, condition.model)
#                 Df   AIC   BIC logLik deviance  Chisq Chi Df Pr(>Chisq)    
# null.model       2 21122 21138 -10559    21118                             
...
# interaction.model: go ~ Group * condition + (1 | scores.SID)
#                   Df   AIC   BIC logLik deviance  Chisq Chi Df Pr(>Chisq)    
...
# Fixed effects:
#                  Estimate Std. Error z value Pr(>|z|)    
# (Intercept)      -0.57912    0.20946  -2.765  0.00570 ** 
# Group            -0.02002    0.13207  -0.152  0.87953    
# condition3        0.01531    0.12893   0.119  0.90550    
# condition4       -0.38861    0.13072  -2.973  0.00295 ** 
# Group:condition3  0.07836    0.08130   0.964  0.33512    
# Group:condition4  0.37571    0.08185   4.590 4.43e-06 ***

#### These are the results I'm getting... I'm not understanding right now why it's giving us different results-- both aren't giving full results.

#  Groups     Name        Variance Std.Dev.
#  scores.SID (Intercept) 0.4869   0.6977  
# Number of obs: 16580, groups:  scores.SID, 139
# 
# Fixed effects:
#                  Estimate Std. Error z value Pr(>|z|)    
# (Intercept)      -0.70353    0.19586  -3.592 0.000328 ***
# Group             0.13132    0.12340   1.064 0.287243    
# condition1        0.12445    0.07496   1.660 0.096865 .  
# condition2        0.13973    0.07458   1.873 0.061008 .  
# Group:condition1 -0.15137    0.04718  -3.208 0.001335 ** 
# Group:condition2 -0.07299    0.04687  -1.557 0.119430   
...
interaction.model <- glmer(go ~ Group*condition + (1|scores.SID), data= social_df_TDSall, family='binomial')
anova(null.model, interaction.model)  
#                   Df   AIC   BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)    
# null.model         2 14192 14207 -7094.0    14188                             
# interaction.model  5 14181 14217 -7085.3    14171 17.449      3  0.0005713 ***
...
# Fixed effects:
#                  Estimate Std. Error z value Pr(>|z|)    
# (Intercept)      -0.55162    0.20556  -2.684 0.007285 ** 
# Group             0.05357    0.12952   0.414 0.679157    
# condition4       -0.40660    0.13052  -3.115 0.001838 ** 
# Group:condition4  0.29853    0.08148   3.664 0.000248 ***
...
interaction.model <- glmer(go_cr ~ Group*run_index + (1|scores.SID), data= allTDSfMRI, family='binomial')
anova(null.model, interaction.model) 
#                   Df   AIC   BIC  logLik deviance Chisq Chi Df Pr(>Chisq)
# null.model         2 16232 16247 -8114.0    16228                        
# interaction.model 13 16238 16338 -8105.8    16212 16.32     11     0.1297
anova(null.model, run.model) 
#            Df   AIC   BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)
# null.model  2 16232 16247 -8114.0    16228                         
...
# Fixed effects:
#                  Estimate Std. Error z value Pr(>|z|)    
# (Intercept)      -1.39240    0.20336  -6.847 7.54e-12 ***
# Group            -0.08620    0.12886  -0.669  0.50351    
# run_index4       -0.18635    0.21792  -0.855  0.39248    
# run_index5       -0.21901    0.21746  -1.007  0.31386    
# run_index6        0.01615    0.21509   0.075  0.94015    
# run_index7       -0.37692    0.21948  -1.717  0.08592 .  
# run_index8       -0.50320    0.21989  -2.288  0.02211 *  
# Group:run_index4  0.13868    0.13783   1.006  0.31434    
# Group:run_index5  0.17125    0.13736   1.247  0.21250    
# Group:run_index6  0.04436    0.13661   0.325  0.74537    
# Group:run_index7  0.31196    0.13741   2.270  0.02319 *  
# Group:run_index8  0.38798    0.13742   2.823  0.00475 ** 
...
interaction.model <- glmer(go_cr ~ Group*condition + (1|scores.SID), data= allTDSfMRI, family='binomial')
anova(null.model, interaction.model)         
#                   Df   AIC   BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)  
# null.model         2 16232 16247 -8114.0    16228                           
...
# Fixed effects:
#                   Estimate Std. Error z value Pr(>|z|)    
# (Intercept)      -1.485697   0.172326  -8.621  < 2e-16 ***
# Group            -0.016515   0.108732  -0.152  0.87928    
# condition3       -0.006365   0.153219  -0.042  0.96687    
# condition4       -0.347296   0.155792  -2.229  0.02580 *  
# Group:condition3  0.037212   0.096759   0.385  0.70055    
# Group:condition4  0.280623   0.097130   2.889  0.00386 ** 
...
interaction.model <- glmer(go_cr ~ Group*condition + (1|scores.SID), data= social_df_TDSall, family='binomial')
anova(null.model, interaction.model)         
#                   Df   AIC   BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)  
# null.model         2 10941 10956 -5468.5    10937                           
# interaction.model  5 10938 10974 -5463.9    10928 9.1116      3    0.02784 *
anova(null.model, condition.model)         
#                 Df   AIC   BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)
# null.model       2 10941 10956 -5468.5    10937                         
...
# Fixed effects:
#                  Estimate Std. Error z value Pr(>|z|)    
# (Intercept)      -1.48135    0.16371  -9.049   <2e-16 ***
# Group             0.01980    0.10309   0.192   0.8477    
# condition4       -0.34153    0.15491  -2.205   0.0275 *  
# Group:condition4  0.24349    0.09636   2.527   0.0115 *    
...
interaction.model <- glmer(stop ~ Group*run_index + (1|scores.SID), data= allTDSfMRI, family='binomial')

anova(null.model, interaction.model)
#                   Df   AIC   BIC logLik deviance  Chisq Chi Df Pr(>Chisq)    
# null.model         2 21608 21623 -10802    21604                             
# interaction.model 13 21586 21686 -10780    21560 44.277     11    6.5e-06 ***
...
# Fixed effects:
#                  Estimate Std. Error z value Pr(>|z|)    
# (Intercept)       0.02875    0.21679   0.133 0.894510    
# Group             0.20803    0.13697   1.519 0.128820    
# run_index4        0.26257    0.17893   1.467 0.142252    
# run_index5        0.43554    0.17883   2.435 0.014872 *  
# run_index6        0.13767    0.17841   0.772 0.440307    
# run_index7        0.64884    0.18102   3.584 0.000338 ***
# run_index8        0.77646    0.18032   4.306 1.66e-05 ***
# Group:run_index4 -0.13450    0.11332  -1.187 0.235251    
# Group:run_index5 -0.29133    0.11308  -2.576 0.009985 ** 
# Group:run_index6 -0.12493    0.11295  -1.106 0.268699    
# Group:run_index7 -0.46407    0.11382  -4.077 4.56e-05 ***
# Group:run_index8 -0.56375    0.11349  -4.967 6.79e-07 ***


## Condition effects on the proportion of Stop decisions
null.model <- glmer(stop ~ (1|scores.SID), data=allTDSfMRI, family='binomial')
condition.model <- glmer(stop ~ condition + (1|scores.SID), data=allTDSfMRI, family='binomial')
interaction.model <- glmer(stop ~ Group*condition + (1|scores.SID), data= allTDSfMRI, family='binomial')
anova(null.model, interaction.model)
#                   Df   AIC   BIC logLik deviance  Chisq Chi Df Pr(>Chisq)    
# null.model         2 21608 21623 -10802    21604                             
...
# Fixed effects:
#                  Estimate Std. Error z value Pr(>|z|)    
# (Intercept)       0.15977    0.19790   0.807   0.4195    
# Group             0.14090    0.12491   1.128   0.2593    
# condition3        0.15528    0.12666   1.226   0.2202    
# condition4        0.58189    0.12832   4.535 5.77e-06 ***
# Group:condition3 -0.14087    0.08011  -1.759   0.0787 .  
# Group:condition4 -0.44693    0.08065  -5.542 3.00e-08 *** 
...
interaction.model <- glmer(stop ~ Group*condition + (1|scores.SID), data= social_df_TDSall, family='binomial')
anova(null.model, interaction.model)
#                   Df   AIC   BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)    
# null.model         2 14425 14440 -7210.6    14421                             
# interaction.model  5 14414 14451 -7202.2    14404 16.836      3  0.0007638 ***
anova(null.model, condition.model)
#                 Df   AIC   BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)
# null.model       2 14425 14440 -7210.6    14421                         
...
# Fixed effects:
#                   Estimate Std. Error z value Pr(>|z|)    
# (Intercept)       0.320859   0.200960   1.597 0.110349    
# Group            -0.003696   0.126710  -0.029 0.976728    
# condition4        0.424400   0.128728   3.297 0.000978 ***
# Group:condition4 -0.304933   0.080637  -3.782 0.000156 ***
...
interaction.model <- glmer(stop_nocar ~ Group*run_index + (1|scores.SID), data= allTDSfMRI, family='binomial')
...
interaction.model <- glmer(stop_nocar ~ Group*condition + (1|scores.SID), data= allTDSfMRI, family='binomial')
...
# Fixed effects:
#                  Estimate Std. Error z value Pr(>|z|)    
# (Intercept)      -1.06958    0.12820  -8.343   <2e-16 ***
# Group             0.09956    0.08061   1.235   0.2168    
# condition3        0.08070    0.13513   0.597   0.5504    
# condition4        0.26823    0.13615   1.970   0.0488 *  
# Group:condition3 -0.09177    0.08499  -1.080   0.2802    
# Group:condition4 -0.24024    0.08578  -2.801   0.0051 **    
...
interaction.model <- glmer(stop_nocar ~ Group*condition + (1|scores.SID), data= social_df_TDSall, family='binomial')

anova(null.model, interaction.model)
#                   Df   AIC   BIC  logLik deviance  Chisq Chi Df Pr(>Chisq)
# null.model         2 12871 12886 -6433.6    12867                         
# interaction.model  5 12873 12909 -6431.4    12863 4.4709      3     0.2149
...
# Fixed effects:
#                   Estimate Std. Error z value Pr(>|z|)    
# (Intercept)      -0.991314   0.130152  -7.617 2.61e-14 ***
# Group             0.008613   0.082071   0.105   0.9164    
# condition4        0.187341   0.136711   1.370   0.1706    
# Group:condition4 -0.148420   0.086326  -1.719   0.0856 .  
...
#   Res.Df    RSS Df Sum of Sq      F Pr(>F)
# 1  15978 3238.8                           
# 2  15974 3237.9  4   0.93759 1.1564  0.328
anova(null.model, group.model)
#   Res.Df    RSS Df Sum of Sq      F    Pr(>F)    
# 1  15978 3238.8                                  
# 2  15968 3199.3 10    39.532 19.731 < 2.2e-16 ***
...
fig_4a <- ggplot(data=allTDSfMRI, aes(x=age, y=pred_go, color=condition)) +
  geom_line(aes(group=condition), size=1) +
  labs(x='Age', y='Predicted probability of Go decisions', color='Condition') +
  theme(text = element_text(size=16)) +
  scale_colour_discrete(labels=condition_labels)

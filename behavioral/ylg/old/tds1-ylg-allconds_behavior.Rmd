...
#similarly, we did not see a difference in bad go decisions across social context for CWI teens.
...
write.csv(df_RWR_fMRI, file = 'df_RWR_fMRI.csv')
...
#performance on stop decisions across conditions has is significantly associated with self reported impulsivity -- need to look at it to disentangle 
...
anova(null.model, main.model)
# Model 1: scores.sss_total ~ stop + (1 | scores.SID)
# Model 2: scores.sss_total ~ stop + condition + (1 | scores.SID)
#   Res.Df    RSS Df Sum of Sq      F Pr(>F)
# 1   7938 485.31                           
...
#performance on stop decisions across conditions has no relationship with sensation seeking
...
summary(null.model)
#               Df Sum Sq Mean Sq F value Pr(>F)  
# stop           1    0.3  0.3425    5.03 0.0249 *
# Residuals   7938  540.5  0.0681 

#also no difference in sensitivity to punishment
...
#stop decisons across decision are not related to sensitivity to reward or punishment

...
df <- merge(demo_filtered, ylg_filtered, by = 'subject.name')
...
fig_2a <- ggplot(plot_group_go, aes(x = run_index, y = mean)) +
  geom_point() +
  geom_line() +
  geom_line(aes(data=line, aes(x = run_index, y = mean))) +
...
## STOPPED HERE 8/28/2017 - UPDATE THE REST BELOW

...
cred_file_location <- '~/Desktop/credentials.yaml.DEFAULT'
pid_column_name <- 'SID'
age_var <- 'Age'
gender_var <- 'Gender'
...
output_file_dir <- '~/Desktop/Output /'
tds2_wave1_rubric_dir <- '~/Desktop/TDS_scripts/behavioral/score_qualtrics_tds/rubrics/tds2/wave1/'
tds2_wave2_rubric_dir <- '~/Desktop/TDS_scripts/behavioral/score_qualtrics_tds/rubrics/tds2/wave2/'
tds1_wave1_rubric_dir <- '~/Desktop/TDS_scripts/behavioral/score_qualtrics_tds/rubrics/tds1/wave1/post/'
tds1_wave1_rubric_dir_pre <-'~/Desktop/TDS_scripts/behavioral/score_qualtrics_tds/rubrics/tds1/wave1/pre/'
tds1_wave2_rubric_dir <- '~/Desktop/TDS_scripts/behavioral/score_qualtrics_tds/rubrics/tds1/wave2/'
TDS1_name <- 'tds1'
TDS2_name <- 'tds2'
wave1_name <- 'wave1'
wave2_name <- 'wave2'
...
write.csv(tds2_wave1_bis_scored_wide$scores, '~/Desktop/Output /')
```

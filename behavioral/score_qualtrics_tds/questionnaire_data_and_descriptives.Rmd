...
knitr::opts_chunk$set(error = T, warning = T, message = F, fig.width = (11-2)/2, fig.height = (8.5-2)/2)
...
BFNERubric <- tds2_wave1_scoring_data_long %>%
...
BISRubric <- tds2_wave1_scoring_data_long %>%

...
rubric_base <- '~/code_new/TDS_scripts/behavioral/score_qualtrics_tds/rubrics/'
tds2_wave1_rubric_dir <- file.path(rubric_base, 'tds2/wave1/')
tds2_wave2_rubric_dir <- file.path(rubric_base, 'tds2/wave2/')
tds1_wave1_rubric_dir <- file.path(rubric_base, 'tds1/wave1/post/')
tds1_wave1_rubric_dir_pre <- file.path(rubric_base, 'tds1/wave1/pre/')
tds1_wave2_rubric_dir <- file.path(rubric_base, 'tds1/wave2/')
TDS1_name <- 'tds1'
TDS2_name <- 'tds2'
wave1_name <- 'wave1'
wave2_name <- 'wave2'

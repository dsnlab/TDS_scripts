...
if(run_strategy){
  ...
  rm(gordon_models);gc()
  save(gordon_modelsDT, file= paste0("/Volumes/TDS/bids_data/derivatives/strategic_connectivity/",
...
if(run_condition){
  system.time(
    condition_models<-mclapply(X=as.character(as.list(gordon_cois$coi)), 
                               demodata=ylg_timing,
                               coidat=gordon_coisDT,
                               mc.cores=numcores,
                               FUN=function(coi_name, demodata, coidat){

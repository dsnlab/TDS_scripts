...
model_time_by_condition<-ggplot(conditions_timing,
                         aes(y=time,
                             x=condition,
                             group=1))+
  geom_line(data=comm.data.pred,
              aes(x=condition, y=time,group=1), size=1, colour="maroon1")+
  geom_ribbon(data=comm.data.pred,
              aes(ymin=y.lower, ymax=y.upper,group=1), alpha=0.4, fill="maroon1")+
  geom_line(data=foster.data.pred,
              aes(x=condition, y=time,group=1), size=1, colour="maroon4")+
  geom_ribbon(data=foster.data.pred,
              aes(ymin=y.lower, ymax=y.upper,group=1), alpha=0.4, fill="maroon4")+

...
# Make a heat map YO!
heatmap<-matrix(data = test_analysis_heatmap$chisq,nrow=345,ncol=345)
rownames(heatmap)<-gordon_key$heatmap_name
colnames(heatmap)<-gordon_key$heatmap_name

cormatrix <- cor(heatmap)
corrplot(cormatrix, method="color")

lattice::levelplot(heatmap[1:ncol(heatmap),ncol(heatmap):1])
new.palette=colorRampPalette(c("black","red","yellow","white"),space="rgb") 
lattice::levelplot(heatmap[1:ncol(heatmap),ncol(heatmap):1],col.regions=new.palette(20))
```

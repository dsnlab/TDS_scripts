...
# previously the script called this preprocessedcomplete$subs, but I couldn't figure out where that was defined so this is hard coded like a LAME-O. 
coi_subs=c("sub-104", "sub-105", "sub-106", "sub-108", "sub-109", "sub-110", "sub-113", "sub-114", "sub-115", "sub-117", "sub-120", "sub-121", "sub-122", "sub-124", "sub-125", "sub-126", "sub-127", "sub-128", "sub-129", "sub-130", "sub-131", "sub-132", "sub-134", "sub-135", "sub-136", "sub-137", "sub-140", "sub-141", "sub-142", "sub-144", "sub-145", "sub-146", "sub-150", "sub-151", "sub-152", "sub-155", "sub-156", "sub-158", "sub-159", "sub-162", "sub-163", "sub-165", "sub-167", "sub-168", "sub-169", "sub-170", "sub-171", "sub-173", "sub-174", "sub-175", "sub-177", "sub-178", "sub-181", "sub-182", "sub-183", "sub-184", "sub-185", "sub-187", "sub-188", "sub-190", "sub-193", "sub-194", "sub-195", "sub-196", "sub-301", "sub-302", "sub-303", "sub-304", "sub-306", "sub-307", "sub-308", "sub-310", "sub-312", "sub-313", "sub-314", "sub-315", "sub-321", "sub-322", "sub-323", "sub-324", "sub-327", "sub-328", "sub-329", "sub-330", "sub-332", "sub-333", "sub-334", "sub-335", "sub-336", "sub-339", "sub-340", "sub-341", "sub-342", "sub-343", "sub-345", "sub-346", "sub-352", "sub-355", "sub-356", "sub-357", "sub-359", "sub-360", "sub-364", "sub-401", "sub-402", "sub-403", "sub-404", "sub-407", "sub-408")

# how many subjects are in the analysis? (has behavior AND resting state data)
sum(demographicsDF$sub %in% coi_subs)
...
#   
#   subjDF <- subjDF %>%
#     filter(grepl("aseg", coi) #this filter step selects connections to amygdala, hippocampus only; note that `& grepl("lh.L_a24", coi) & grepl("rh.R_a24", coi)))' doesn't work
# 
...
# # rh.R_a24: R sgACC
# 
# system.time(gordon_cois <- mclapply(as.list(coi_subs),
...
if(rerun_models){
  system.time(
    gordon_models<-mclapply(X=as.list(gordon_cois$coi), 
...
# Search for subgenual ACC parcels
...
parcels=read.csv("/Users/theresacheng/projects/dsnlab/tds/TDS_scripts/rsfMRI/Cheng_SAP/Parcels/Parcels.csv")

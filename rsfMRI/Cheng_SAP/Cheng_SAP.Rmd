...
#setwd("/Volumes/TDS/bids_data/derivatives/Cheng_SAP/")
...
#take coiname and match to a network
gordon_modelsDT$coiname
"aseg_\d\d_"

# take coi names starting from roi or 

Nonly_best=filter(gordon_modelsDT, mod_type=="neglect only model")
NA_ME_best=filter(gordon_modelsDT, mod_type=="neglect and abuse main model")
NbyA_best=filter(gordon_modelsDT, mod_type=="neglect and abuse interaction model")

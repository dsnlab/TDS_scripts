...
#saveRDS(gordon_modelsDT_AIC, "/Volumes/TDS/bids_data/derivatives/Cheng_SAP/gordon_modelsDT_AIC.RDS")
...
if(rerun_modelCompare){
  system.time(
    gordon_models_logLik<-mclapply(X=as.list(gordon_cois$coi), 
      demodata=demographicsDF,
      coidat=gordon_coisDT,
      mc.cores=1,
      FUN=function(coi_name, demodata, coidat){
...
i=3
  ...
  print(object.size(gordon_models_logLik), units='Mb')
  gordon_modelsDT_logLik <- rbindlist(gordon_models_logLik) #make this into a dataframe
  print(object.size(gordon_modelsDT_logLik), units='Mb')
  rm(gordon_models_logLik);gc()
}

# saveRDS(gordon_modelsDT_logLik, "/Volumes/TDS/bids_data/derivatives/Cheng_SAP/gordon_modelsDT_logLik.RDS")

...
# Create csv file
 # Change the names from string into numbers:
  ...
  file$meanC_pmod = file$pmod - 6.184874 #Comment out this line and run script without meanC_pmod first. Use this output with "Finding grand mean.R" script to identify appropriate value for centering. Then re-run this script with correct mean value.

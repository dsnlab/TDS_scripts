...
COMPNAME=ralph
SCRIPT=/Users/${COMPNAME}/Documents/${STUDY}/fMRI/scripts/fx/models/ylg/contrasts/load_custom_contrast.m

# Tag the results files
RESULTS_INFIX=fx_allconds_contrasts

# Set output dir
OUTPUTDIR=/Users/${COMPNAME}/Documents/${STUDY}/fMRI/scripts/fx/models/ylg/contrasts/output/

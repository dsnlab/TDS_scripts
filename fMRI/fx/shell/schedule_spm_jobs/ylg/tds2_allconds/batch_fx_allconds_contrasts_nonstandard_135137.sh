...
SUBJLIST=`cat subject_list_fx_135137.txt`
...
SCRIPT=${STUDY}/fMRI/fx/models/ylg/contrasts/fx_ylg_allconds_simple_135137.m

# Tag the results files
RESULTS_INFIX=fx_ylg_allconds_contrasts

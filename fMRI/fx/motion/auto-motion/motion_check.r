...
subjsDir<-'/Volumes/TDS/nonbids_data/derivatives/fMRI/ppc/subjects_tds1_tds2' 
# requires trailing '/' - this is the path to prepend to output pdf filename. 
motionPDFdir<-'/Volumes/TDS/nonbids_data/derivatives/fMRI/fx/motion/auto-motion-output/tds1_tds2/' 
# requires trailing '/' - this is where the augmented rp_*txt files go
motion_rp_txt_dir<-'/Volumes/TDS/nonbids_data/derivatives/fMRI/fx/motion/auto-motion-output/tds1_tds2/rp_txt/'

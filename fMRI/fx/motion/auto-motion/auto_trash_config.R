...
#------------------------------------------------------
# paths
rpDir = '/Volumes/TDS/nonbids_data/derivatives/fMRI/fx/motion/auto-motion-output/tdsall/rp_txt/'
outputDir = '/Volumes/TDS/nonbids_data/derivatives/fMRI/fx/motion/auto-motion-output/tdsall/'
rpOutputDir = '/Volumes/TDS/nonbids_data/derivatives/fMRI/fx/motion/auto-motion-output/tdsall/rp_auto_txt/'
plotDir = '/Volumes/TDS/nonbids_data/derivatives/fMRI/fx/motion/auto-motion-output/tdsall/plots/'

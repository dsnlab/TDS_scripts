...
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects_tds2/101/stop5'};
...
matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects_tds2/101/stop6'};
...
matlabbatch{5}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects_tds2/101/stop7'};
...
matlabbatch{6}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects_tds2/101/stop8'};
...
matlabbatch{7}.spm.stats.fmri_spec.dir = {'/projects/dsnlab/tds/fMRI/analysis/fx/models/ylg/fx_ylg_allconds_nonorth/101'};
...
matlabbatch{7}.spm.stats.fmri_spec.sess(1).multi = {'/projects/dsnlab/tds/fMRI/analysis/fx/multicond/ylg/multicond_decout_pmod_101_stopALONE.mat'};
matlabbatch{7}.spm.stats.fmri_spec.sess(1).regress = struct('name', {}, 'val', {});
matlabbatch{7}.spm.stats.fmri_spec.sess(1).multi_reg = {'/projects/dsnlab/tds/fMRI/analysis/fx/motion/auto-motion-output/rp_auto_txt/rp_101_alone.txt'};
...
matlabbatch{7}.spm.stats.fmri_spec.sess(2).multi = {'/projects/dsnlab/tds/fMRI/analysis/fx/multicond/ylg/multicond_decout_pmod_101_stopPEER.mat'};
matlabbatch{7}.spm.stats.fmri_spec.sess(2).regress = struct('name', {}, 'val', {});
matlabbatch{7}.spm.stats.fmri_spec.sess(2).multi_reg = {'/projects/dsnlab/tds/fMRI/analysis/fx/motion/auto-motion-output/rp_auto_txt/rp_101_peer.txt'};
...
matlabbatch{7}.spm.stats.fmri_spec.sess(3).multi = {'/projects/dsnlab/tds/fMRI/analysis/fx/multicond/ylg/multicond_decout_pmod_101_stopEXCL.mat'};
matlabbatch{7}.spm.stats.fmri_spec.sess(3).regress = struct('name', {}, 'val', {});
matlabbatch{7}.spm.stats.fmri_spec.sess(3).multi_reg = {'/projects/dsnlab/tds/fMRI/analysis/fx/motion/auto-motion-output/rp_auto_txt/rp_101_excl.txt'};

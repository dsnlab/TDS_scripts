...
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects_tds2/139/stop3'};
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '^swrustop3*';
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects_tds2/139/stop4'};
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '^swrustop4*';
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects_tds2/139/stop5'};
...
matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects_tds2/139/stop6'};
...
matlabbatch{5}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects_tds2/139/stop7'};
...
matlabbatch{6}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects_tds2/139/stop8'};
...
matlabbatch{7}.spm.stats.fmri_spec.dir = {'/projects/dsnlab/tds/fMRI/analysis/fx/models/ylg/fx_ylg_allconds_nonorth/139'};
...
matlabbatch{7}.spm.stats.fmri_spec.sess(1).multi = {'/projects/dsnlab/tds/fMRI/analysis/fx/multicond/ylg/multicond_decout_pmod_139_stopALONE.mat'};
matlabbatch{7}.spm.stats.fmri_spec.sess(1).regress = struct('name', {}, 'val', {});
matlabbatch{7}.spm.stats.fmri_spec.sess(1).multi_reg = {'/projects/dsnlab/tds/fMRI/analysis/fx/motion/auto-motion-output/rp_auto_txt/rp_139_alone.txt'};
...
matlabbatch{7}.spm.stats.fmri_spec.sess(2).multi = {'/projects/dsnlab/tds/fMRI/analysis/fx/multicond/ylg/multicond_decout_pmod_139_stopPEER.mat'};
matlabbatch{7}.spm.stats.fmri_spec.sess(2).regress = struct('name', {}, 'val', {});
matlabbatch{7}.spm.stats.fmri_spec.sess(2).multi_reg = {'/projects/dsnlab/tds/fMRI/analysis/fx/motion/auto-motion-output/rp_auto_txt/rp_139_peer.txt'};
...
matlabbatch{7}.spm.stats.fmri_spec.sess(3).multi = {'/projects/dsnlab/tds/fMRI/analysis/fx/multicond/ylg/multicond_decout_pmod_139_stopEXCL.mat'};
matlabbatch{7}.spm.stats.fmri_spec.sess(3).regress = struct('name', {}, 'val', {});
matlabbatch{7}.spm.stats.fmri_spec.sess(3).multi_reg = {'/projects/dsnlab/tds/fMRI/analysis/fx/motion/auto-motion-output/rp_auto_txt/rp_139_excl.txt'};

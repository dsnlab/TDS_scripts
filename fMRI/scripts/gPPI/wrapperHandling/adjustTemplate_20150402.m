studyDir = '/vxfsvol/hovvme/research/tds/';
load([studyDir 'scripts/gPPI/mats/ppi_master_template.mat'])
...
P.maskdir = [studyDir 'fMRI/analysis/roi/cyb/cyb_events/noage_covariate/catch_meanCpmod_linear_w190/F_pmod/excP_over_incP/subpeaks']; 

...
f = '/Volumes/research/tds/fMRI/analysis/fx/multicond/cyberball/TDS2_cyb_summary/events';
g = '/Volumes/research/tds/fMRI/analysis/fx/multicond/cyberball/TDS2_cyb_NOD/events/events_pmod_noquad';
...
durations{1,2}=pc(:,3);
durations{1,3}=ct_2C(:,3);
durations{1,4}=ct_2P(:,3);
%durations{1,5}=pc(:,3);
...
%% SAVE
%sub ID
saveName=strcat('t',M{2}(1),'_2_NOD.mat') % CHANGE FOR CYB_1 or _2!

...
labeled_cyberball_folder<-'behavioral/cyberball/TDS2_labeled_cyb_data'
labeled_files_folder<-paste(tds_folder,labeled_cyberball_folder,sep='')
summary_cyberball_folder<-'behavioral/cyberball/TDS2_cyb_summary/events'
...
file$meanC_pmod = file$pmod - 2.748

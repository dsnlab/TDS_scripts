...
COMPNAME=ralph
SCRIPT=/Users/${COMPNAME}/Documents/${STUDY}/fMRI/scripts/templates/masks/tds_gw_join_and_smooth.m
SCRIPTNAME=tds_gw_mask

# Set output dir
OUTPUTDIR=/Users/${COMPNAME}/Documents/${STUDY}/fMRI/scripts/templates/masks/output

...
COMPNAME=ralph
SCRIPT=/Users/${COMPNAME}/Documents/${STUDY}/fMRI/scripts/templates/masks/spm/tds2/tds_gw_groupAverage_optthresh_job.m
SCRIPTNAME=tds_gw_grpAvg_optthresh

# Tag the results files
# RESULTS_INFIX=grpAvg_optthresh

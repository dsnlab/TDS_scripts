...
matlabbatch{1}.spm.util.imcalc.input = {
                                        '/projects/dsnlab/tds/fMRI/subjects_tds2/101/structurals/wc1mprage.nii,1'
                                        '/projects/dsnlab/tds/fMRI/subjects_tds2/101/structurals/wc2mprage.nii,1'
                                        };
matlabbatch{1}.spm.util.imcalc.output = '101_gw_join';
matlabbatch{1}.spm.util.imcalc.outdir = {'/projects/dsnlab/tds/fMRI/analysis/masks/tds2'};

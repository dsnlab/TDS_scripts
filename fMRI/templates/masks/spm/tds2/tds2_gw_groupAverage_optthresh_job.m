...
% spm SPM - SPM12 (6906)
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/analysis/masks/tds2'};
...
matlabbatch{2}.spm.util.imcalc.output = 'tds2_gw_smoothed_group_average.nii';
matlabbatch{2}.spm.util.imcalc.outdir = {'/projects/dsnlab/tds/fMRI/analysis/masks/tds2'};

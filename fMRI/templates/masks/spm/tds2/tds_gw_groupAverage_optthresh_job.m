...
% spm SPM - SPM12 (6906)
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/Users/ralph/Documents/tds/fMRI/analysis/masks/tds2'};
...
matlabbatch{2}.spm.util.imcalc.output = 'tds_gw_smoothed_group_average.nii';
matlabbatch{2}.spm.util.imcalc.outdir = {'/Users/ralph/Documents/tds/fMRI/analysis/masks/tds2'};
...
matlabbatch{3}.spm.tools.masking{1}.optthr.inname(1) = cfg_dep('Image Calculator: ImCalc Computed Image: tds_gw_smoothed_group_average.nii', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{3}.spm.tools.masking{1}.optthr.outdir = {'/Users/ralph/Documents/tds/fMRI/analysis/masks/tds2'};

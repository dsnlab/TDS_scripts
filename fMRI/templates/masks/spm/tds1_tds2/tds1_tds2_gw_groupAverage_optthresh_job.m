...
% spm SPM - SPM12 (6906)
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/shared/tds/fMRI/analysis/masks/tds1_tds2'};
...
matlabbatch{2}.spm.util.imcalc.outdir = {'/projects/dsnlab/shared/tds/fMRI/analysis/masks/tds1_tds2'};
...
matlabbatch{3}.spm.tools.masking{1}.optthr.outdir = {'/projects/dsnlab/shared/tds/fMRI/analysis/masks/tds1_tds2'};

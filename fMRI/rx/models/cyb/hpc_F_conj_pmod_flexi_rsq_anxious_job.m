%-----------------------------------------------------------------------
% Job saved on 28-Sep-2017 20:22:38 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6470)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = {'/Volumes/TDS/nonbids_data/derivatives/fMRI/rx/cyb/tds2_N69/F_conj_pmod_flexi_rsq_anxious_w_resid'};
...
%%
matlabbatch{1}.spm.stats.factorial_design.cov.c = [-0.32
-0.32
5.51
5.51
-1.61
...
6.61];
%%
matlabbatch{1}.spm.stats.factorial_design.cov.cname = 'rsq_anxious';

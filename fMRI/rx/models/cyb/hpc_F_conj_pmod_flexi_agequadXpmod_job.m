%-----------------------------------------------------------------------
% Job saved on 28-Sep-2017 20:25:18 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6470)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = {'/Volumes/TDS/nonbids_data/derivatives/fMRI/rx/cyb/tds2_N69/F_conj_pmod_flexi_agequadXpmod'};
...
matlabbatch{1}.spm.stats.factorial_design.cov(2).c = [1.703706456
                                                      ...
                                                      0.000309402];
%%
matlabbatch{1}.spm.stats.factorial_design.cov(2).cname = 'agequad';

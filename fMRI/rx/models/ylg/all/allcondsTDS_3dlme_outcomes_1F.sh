...
cd /projects/dsnlab/tds/fMRI/analysis/rx/ylg/all/tds2/3dLME/Outcomes/OutcomesF 
	3dLME -prefix DecXOutcomesXContextTDS2F \
	-jobs 28 \
	...
	-num_glf 1 \
	-glfLabel 1 'OGG-OGS_AL-SE' -glfCode  1 'Dec : 1*Go - 1*Stop Outcome : 1*Good - 1*Stop Context : 1*AL -1*SE' \

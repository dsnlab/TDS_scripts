...
rx_path=/projects/dsnlab/shared/tds/fMRI/analysis/rx/ylg/all/tds2/3dMVM_nopmod/DecisionsXContext/
...
3dClustSim -mask $mask -acf 0.73527 4.6591 12.53 > ${rx_path}/TDS2_threshold.txt

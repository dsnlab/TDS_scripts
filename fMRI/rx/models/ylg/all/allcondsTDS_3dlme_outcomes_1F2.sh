...
cd /projects/dsnlab/tds/fMRI/analysis/rx/ylg/all/tds2/3dLME/Outcomes/OutcomesF2 
	...
	-num_glf 1 \
	-glfLabel 1 'OGG_OGBG_AL-SE' -glfCode  1 'Dec : 1*Go Outcome : 1*Good -1*Bad Context : 1*AL -1*SE' \

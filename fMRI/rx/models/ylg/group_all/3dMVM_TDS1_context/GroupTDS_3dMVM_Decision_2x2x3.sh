...
#--------------------------------------------------------------
#
#SBATCH --job-name=TDS1v2_GROUP_dec_3dMVM
#SBATCH --output=output/TDS1v2_GROUP_dec_3dMVM.log
#SBATCH --error=output/TDS1v2_GROUP_dec_3dMVM_error.log
...
cd /projects/dsnlab/shared/tds/fMRI/analysis/rx/ylg/all/tds1/Decisions/
	...
	-gltLabel 4 'D_AL_EA-COM' -gltCode 4  'Decision : 1*DS +1*DG Context : 1*AL  Group : 1*EA -1*COM' \
	-gltLabel 5 'D_PR_EA-COM' -gltCode 5  'Decision : 1*DS +1*DG Context : 1*PR Group : 1*EA -1*COM' \
	-gltLabel 6 'D_SE_EA-COM' -gltCode 6  'Decision : 1*DS +1*DG Context : 1*SE Group : 1*EA -1*COM' \
	...
	-gltLabel 13 'DS_AL-PR_EA-COM' -gltCode 13  'Decision : 1*DS Context : 1*AL -1*PR Group : 1*EA -1*COM' \
	-gltLabel 14 'DG_AL-PR_EA-COM' -gltCode 14  'Decision : 1*DG Context : 1*AL -1*PR Group : 1*EA -1*COM' \
	-gltLabel 15 'DS_AL-SE_EA-COM' -gltCode 15  'Decision : 1*DS Context : 1*AL -1*SE Group : 1*EA -1*COM' \
	-gltLabel 16 'DG_AL-SE_EA-COM' -gltCode 16  'Decision : 1*DG Context : 1*AL -1*SE Group : 1*EA -1*COM' \
	-gltLabel 17 'DS_PR-SE_EA-COM' -gltCode 17  'Decision : 1*DS Context : 1*PR -1*SE Group : 1*EA -1*COM' \
	-gltLabel 18 'DG_PR-SE_EA-COM' -gltCode 18  'Decision : 1*DG Context : 1*PR -1*SE Group : 1*EA -1*COM' \
	-gltLabel 19 'D_AL_vs_Social_EA-COM' -gltCode 19  'Decision : 1*DS +1*DG Context : 2*AL -1*PR +1*SE  Group : 1*EA -1*COM' \
	-gltLabel 20 'DGo_AL_vs_Social_EA-COM' -gltCode 20  'Decision : 1*DG Context : 2*AL -1*PR +1*SE  Group : 1*EA -1*COM' \
	-gltLabel 21 'DStop_AL_vs_Social_EA-COM' -gltCode 21  'Decision : 1*DS Context : 2*AL -1*PR +1*SE  Group : 1*EA -1*COM' \
	-gltLabel 22 'D_PRspecific_EA-COM' -gltCode 22  'Decision : 1*DS +1*DG Context : 2*PR -1*AL +1*SE  Group : 1*EA -1*COM' \
	-gltLabel 23 'DGo_PRspecific_EA-COM' -gltCode 23  'Decision : 1*DG Context : 2*PR -1*AL +1*SE  Group : 1*EA -1*COM' \
	-gltLabel 24 'DStop_PRspecific_EA-COM' -gltCode 24  'Decision : 1*DS Context : 2*PR -1*AL +1*SE  Group : 1*EA -1*COM' \
	-gltLabel 25 'D_SEspecific_EA-COM' -gltCode 25 'Decision : 1*DS +1*DG Context : 2*SE -1*AL +1*PR  Group : 1*EA -1*COM' \
	-gltLabel 26 'DGo_SEspecific_EA-COM' -gltCode 26  'Decision : 1*DG Context : 2*SE -1*AL +1*PR  Group : 1*EA -1*COM' \
	-gltLabel 27 'DStop_SEspecific_EA-COM' -gltCode 27  'Decision : 1*DS Context : 2*SE -1*AL +1*PR  Group : 1*EA -1*COM' \

%-----------------------------------------------------------------------
% Job saved on 12-May-2017 14:14:39 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6906)
%-----------------------------------------------------------------------
...
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.data.presubphasemag.phase = {'/projects/dsnlab/tds/fMRI/subjects/178/fmaps/fieldmap.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.data.presubphasemag.magnitude = {'/projects/dsnlab/tds/fMRI/subjects/178/fmaps/fieldmap_01.nii,1'};
...
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(1).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/cyb1/cyb1_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(2).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/cyb2/cyb2_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(3).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop3/stop3_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(4).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop4/stop4_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(5).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop5/stop5_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(6).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop6/stop6_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(7).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop7/stop7_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(8).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop8/stop8_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(9).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/vid1/vid1_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(10).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/vid2/vid2_0001.nii,1'};
...
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects/178/cyb2'};
...
matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects/178/stop3'};
...
matlabbatch{5}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects/178/stop4'};
...
matlabbatch{6}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects/178/stop5'};
...
matlabbatch{7}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects/178/stop6'};
...
matlabbatch{8}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects/178/stop7'};
...
matlabbatch{9}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects/178/stop8'};
...
matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects/178/vid1'};
...
matlabbatch{11}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects/178/vid2'};
...
matlabbatch{12}.spm.spatial.realignunwarp.data(1).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^cyb2*)', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{12}.spm.spatial.realignunwarp.data(1).pmscan(1) = cfg_dep('Calculate VDM: Voxel displacement map (Subj 1, Session 2)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','vdmfile', '{}',{2}));
matlabbatch{12}.spm.spatial.realignunwarp.data(2).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^stop3*)', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{12}.spm.spatial.realignunwarp.data(2).pmscan(1) = cfg_dep('Calculate VDM: Voxel displacement map (Subj 1, Session 3)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','vdmfile', '{}',{3}));
matlabbatch{12}.spm.spatial.realignunwarp.data(3).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^stop4*)', substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{12}.spm.spatial.realignunwarp.data(3).pmscan(1) = cfg_dep('Calculate VDM: Voxel displacement map (Subj 1, Session 4)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','vdmfile', '{}',{4}));
matlabbatch{12}.spm.spatial.realignunwarp.data(4).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^stop5*)', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{12}.spm.spatial.realignunwarp.data(4).pmscan(1) = cfg_dep('Calculate VDM: Voxel displacement map (Subj 1, Session 5)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','vdmfile', '{}',{5}));
matlabbatch{12}.spm.spatial.realignunwarp.data(5).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^stop6*)', substruct('.','val', '{}',{7}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{12}.spm.spatial.realignunwarp.data(5).pmscan(1) = cfg_dep('Calculate VDM: Voxel displacement map (Subj 1, Session 6)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','vdmfile', '{}',{6}));
matlabbatch{12}.spm.spatial.realignunwarp.data(6).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^stop7*)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{12}.spm.spatial.realignunwarp.data(6).pmscan(1) = cfg_dep('Calculate VDM: Voxel displacement map (Subj 1, Session 7)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','vdmfile', '{}',{7}));
matlabbatch{12}.spm.spatial.realignunwarp.data(7).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^stop8*)', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{12}.spm.spatial.realignunwarp.data(7).pmscan(1) = cfg_dep('Calculate VDM: Voxel displacement map (Subj 1, Session 8)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','vdmfile', '{}',{8}));
matlabbatch{12}.spm.spatial.realignunwarp.data(8).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^vid1*)', substruct('.','val', '{}',{10}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{12}.spm.spatial.realignunwarp.data(8).pmscan(1) = cfg_dep('Calculate VDM: Voxel displacement map (Subj 1, Session 9)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','vdmfile', '{}',{9}));
matlabbatch{12}.spm.spatial.realignunwarp.data(9).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^vid2*)', substruct('.','val', '{}',{11}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{12}.spm.spatial.realignunwarp.data(9).pmscan(1) = cfg_dep('Calculate VDM: Voxel displacement map (Subj 1, Session 10)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','vdmfile', '{}',{10}));

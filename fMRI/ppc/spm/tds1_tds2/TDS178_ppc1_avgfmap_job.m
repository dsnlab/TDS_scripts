...
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(1).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/cyb2/cyb2_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(2).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop3/stop3_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(3).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop4/stop4_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(4).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop5/stop5_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(5).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop6/stop6_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(6).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop7/stop7_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(7).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/stop8/stop8_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(8).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/vid1/vid1_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(9).epi = {'/projects/dsnlab/tds/fMRI/subjects/178/vid2/vid2_0001.nii,1'};

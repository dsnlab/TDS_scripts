...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.tools.dartel.mni_norm.template = {'/projects/dsnlab/tds/fMRI/subjects/dartel_template/tds1_2_template_6.nii'};
matlabbatch{1}.spm.tools.dartel.mni_norm.data.subj.flowfield = {'/projects/dsnlab/tds/fMRI/subjects/101/structurals/u_rc1mprage_tds1_2_template.nii'};
...
matlabbatch{4}.spm.tools.dartel.mni_norm.template = {'/projects/dsnlab/tds/fMRI/subjects/dartel_template/tds1_2_template_6.nii'};
matlabbatch{4}.spm.tools.dartel.mni_norm.data.subj.flowfield = {'/projects/dsnlab/tds/fMRI/subjects/101/structurals/u_rc1mprage_tds1_2_template.nii'};
...
matlabbatch{8}.spm.tools.dartel.mni_norm.template = {'/projects/dsnlab/tds/fMRI/subjects/dartel_template/tds1_2_template_6.nii'};
matlabbatch{8}.spm.tools.dartel.mni_norm.data.subj.flowfield = {'/projects/dsnlab/tds/fMRI/subjects/101/structurals/u_rc1mprage_tds1_2_template.nii'};

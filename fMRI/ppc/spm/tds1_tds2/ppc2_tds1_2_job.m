...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.tools.dartel.mni_norm.template = {'/projects/dsnlab/tds/fMRI/subjects/dartel_template/tds_template_n147_6.nii'};
matlabbatch{1}.spm.tools.dartel.mni_norm.data.subj.flowfield = {'/projects/dsnlab/tds/fMRI/subjects/101/structurals/u_rc1mprage_tds_template_n147.nii'};
matlabbatch{1}.spm.tools.dartel.mni_norm.data.subj.images = {'/projects/dsnlab/tds/fMRI/subjects/101/structurals/mprage.nii'};
matlabbatch{1}.spm.tools.dartel.mni_norm.vox = [1 1 1];
matlabbatch{1}.spm.tools.dartel.mni_norm.bb = [NaN NaN NaN
                                               NaN NaN NaN];
matlabbatch{1}.spm.tools.dartel.mni_norm.preserve = 0;
matlabbatch{1}.spm.tools.dartel.mni_norm.fwhm = [1 1 1];
matlabbatch{2}.cfg_basicio.file_dir.dir_ops.cfg_mkdir.parent = {'/projects/dsnlab/tds/fMRI/subjects/101/structurals'};
...
matlabbatch{4}.spm.tools.dartel.mni_norm.template = {'/projects/dsnlab/tds/fMRI/subjects/dartel_template/tds_template_n147_6.nii'};
matlabbatch{4}.spm.tools.dartel.mni_norm.data.subj.flowfield = {'/projects/dsnlab/tds/fMRI/subjects/101/structurals/u_rc1mprage_tds_template_n147.nii'};
matlabbatch{4}.spm.tools.dartel.mni_norm.data.subj.images = {'/projects/dsnlab/tds/fMRI/subjects/101/structurals/mprage.nii'};
...
matlabbatch{5}.cfg_basicio.file_dir.dir_ops.cfg_mkdir.parent = {'/projects/dsnlab/tds/fMRI/subjects/101/structurals'};
...
matlabbatch{7}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/tds/fMRI/subjects/101'};
...
matlabbatch{8}.spm.tools.dartel.mni_norm.template = {'/projects/dsnlab/tds/fMRI/subjects/dartel_template/tds_template_n147_6.nii'};
matlabbatch{8}.spm.tools.dartel.mni_norm.data.subj.flowfield = {'/projects/dsnlab/tds/fMRI/subjects/101/structurals/u_rc1mprage_tds_template_n147.nii'};

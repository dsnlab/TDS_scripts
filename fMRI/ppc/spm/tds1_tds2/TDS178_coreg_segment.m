...
matlabbatch{2}.spm.spatial.preproc.tissue(1).tpm = {'projects/dsnlab/SPM12/tpm/TPM.nii,1'};
...
matlabbatch{2}.spm.spatial.preproc.tissue(2).tpm = {'projects/dsnlab/SPM12/tpm/TPM.nii,2'};

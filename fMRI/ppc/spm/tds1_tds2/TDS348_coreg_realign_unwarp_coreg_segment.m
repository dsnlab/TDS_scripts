...
matlabbatch{1}.spm.spatial.coreg.estimate.source = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/structurals/mprage.nii,1'};
matlabbatch{1}.spm.spatial.coreg.estimate.other = {''};
matlabbatch{1}.spm.spatial.coreg.estimate.eoptions.cost_fun = 'nmi';
matlabbatch{1}.spm.spatial.coreg.estimate.eoptions.sep = [4 2];
matlabbatch{1}.spm.spatial.coreg.estimate.eoptions.tol = [0.02 0.02 0.02 0.001 0.001 0.001 0.01 0.01 0.01 0.001 0.001 0.001];
matlabbatch{1}.spm.spatial.coreg.estimate.eoptions.fwhm = [7 7];
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.data.presubphasemag.phase = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/fmaps/fieldmap.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.data.presubphasemag.magnitude = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/fmaps/fieldmap_01.nii,1'};
...
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(1).epi = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/cyb1/cyb1_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(2).epi = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/cyb2/cyb2_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(3).epi = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/stop3/stop3_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(4).epi = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/stop4/stop4_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(5).epi = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/stop6/stop6_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(6).epi = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/stop7/stop7_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(7).epi = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/stop8/stop8_0001.nii,1'};
matlabbatch{2}.spm.tools.fieldmap.calculatevdm.subj.session(8).epi = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/vid1/vid1_0001.nii,1'};
...
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/cyb1'};
...
matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/cyb2'};
...
matlabbatch{5}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/stop3'};
...
matlabbatch{6}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/stop4'};
...
matlabbatch{7}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/stop6'};
...
matlabbatch{8}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/stop7'};
...
matlabbatch{9}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/stop8'};
...
matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/shared/tds/fMRI/subjects_tds1_tds2/348/vid1'};
...
matlabbatch{11}.spm.spatial.realignunwarp.data(5).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^stop6*)', substruct('.','val', '{}',{7}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{11}.spm.spatial.realignunwarp.data(6).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^stop7*)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{11}.spm.spatial.realignunwarp.data(7).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^stop8*)', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{11}.spm.spatial.realignunwarp.data(8).scans(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^vid1*)', substruct('.','val', '{}',{10}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));

...
pm_def.INPUT_DATA_FORMAT = 'PM';      % 'RI' = load two real and 
                                      ...
                                      % pairs.
pm_def.SHORT_ECHO_TIME = 4.37;        % Short echo time in ms for Skyra
pm_def.LONG_ECHO_TIME = 6.83;        % Long echo time in ms for Skyra
...
pm_def.TOTAL_EPI_READOUT_TIME = 37.18;   % Skyra EPI RO time for TDS with GRAPPA (echo_spacing*baseline_resolution/2)

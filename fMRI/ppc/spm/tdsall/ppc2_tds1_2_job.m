...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.tools.dartel.mni_norm.template = {'/projects/dsnlab/shared/tds/fMRI/subjects_tdsall/dartel_template/tdsall_template_6.nii'};
matlabbatch{1}.spm.tools.dartel.mni_norm.data.subj.flowfield = {'/projects/dsnlab/shared/tds/fMRI/subjects_tdsall/101/structurals/u_rc1mprage_tds1_tds2_template.nii'};
matlabbatch{1}.spm.tools.dartel.mni_norm.data.subj.images = {'/projects/dsnlab/shared/tds/fMRI/subjects_tdsall/101/structurals/mprage.nii'};
matlabbatch{1}.spm.tools.dartel.mni_norm.vox = [1 1 1];
matlabbatch{1}.spm.tools.dartel.mni_norm.bb = [NaN NaN NaN
                                               NaN NaN NaN];
matlabbatch{1}.spm.tools.dartel.mni_norm.preserve = 0;
matlabbatch{1}.spm.tools.dartel.mni_norm.fwhm = [1 1 1];
matlabbatch{2}.cfg_basicio.file_dir.dir_ops.cfg_mkdir.parent = {'/projects/dsnlab/shared/tds/fMRI/subjects_tdsall/101/structurals'};
...
matlabbatch{4}.spm.tools.dartel.mni_norm.template = {'/projects/dsnlab/shared/tds/fMRI/subjects_tdsall/dartel_template/tdsall_template_6.nii'};
matlabbatch{4}.spm.tools.dartel.mni_norm.data.subj.flowfield = {'/projects/dsnlab/shared/tds/fMRI/subjects_tdsall/101/structurals/u_rc1mprage_tdsall_template.nii'};
matlabbatch{4}.spm.tools.dartel.mni_norm.data.subj.images = {'/projects/dsnlab/shared/tds/fMRI/subjects_tdsall/101/structurals/mprage.nii'};
...
matlabbatch{5}.cfg_basicio.file_dir.dir_ops.cfg_mkdir.parent = {'/projects/dsnlab/shared/tds/fMRI/subjects_tdsall/101/structurals'};
...
matlabbatch{7}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {'/projects/dsnlab/shared/tds/fMRI/subjects_tdsall/101'};
...
matlabbatch{8}.spm.tools.dartel.mni_norm.template = {'/projects/dsnlab/shared/tds/fMRI/subjects_tdsall/dartel_template/tdsall_template_6.nii'};
matlabbatch{8}.spm.tools.dartel.mni_norm.data.subj.flowfield = {'/projects/dsnlab/shared/tds/fMRI/subjects_tdsall/101/structurals/u_rc1mprage_tdsall_template.nii'};

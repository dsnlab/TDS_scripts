...
for s=1:length(subjects)
    ...
    load('SPM.mat')
    save('SPM_oldPath2.mat','SPM')
    
    a=SPM.swd;
    a=[a(1:27) 'fMRI/subjects' a(40:end)]
    
%     for i=1:size(SPM.xY.VY,1)
%         a=SPM.xY.VY(i).fname; % Change SPM.xY.VY
%         a=[a(1:27) 'fMRI/subjects' a(40:49) a(62:end)];
%         SPM.xY.VY(i).fname=a;
%     end
%     
...
%         a=SPM.xY.P(i,:);
%         editedArray(i,1:73)=[a(1:27) 'fMRI/subjects' a(40:49) a(62:84)]
% %         
%        % [a(1:50) a(63:73)];% Change SPM.xY.P
%    end

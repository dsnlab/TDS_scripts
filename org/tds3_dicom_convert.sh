...
fieldmapoutput="${OUTPUTDIR}/fMRI/subjects/tds3/${SUBID}/fmaps"
...
for task in $tasks; do
 mkdir ${task}
 taskoutput="${OUTPUTDIR}/fMRI/subjects/tds3/${SUBID}/${task}"
...
cd $OUTPUTDIR/fMRI/subjects/tds3/$SUBID && mkdir -p structurals && cp $anatomicaloutput/mprage.nii $OUTPUTDIR/fMRI/subjects/tds3/$SUBID/structurals/mprage.nii

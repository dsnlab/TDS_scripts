...
DICOMDIR=$(echo "/raid/data2/scans/dsnlab/TDS/${SUBID}"*)
...
mkdir -p ${OUTPUTDIR}/fMRI/subjects/${SUBID}/
...
cd ${OUTPUTDIR}/fMRI/subjects/${SUBID} && mkdir -p structurals && cp ${anatomicaloutput}/mprage.nii $OUTPUTDIR/fMRI/subjects/$SUBID/structurals/mprage.nii
